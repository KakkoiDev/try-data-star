...
// Database paths
export const DB_PATH = join(projectRoot, "db/database.sqlite");
export const MIGRATIONS_DIR = join(projectRoot, "db/migrations");
export const SEEDS_DIR = join(projectRoot, "db/seeds");
